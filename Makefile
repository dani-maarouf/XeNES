SRC_FILES    = src/main.cpp src/NES.cpp src/gameLoop.cpp src/CPU.cpp src/PPU.cpp src/mappers.cpp src/APU.cpp src/debugger.cpp
HEADER_FILES = include/NES.hpp include/PPU.hpp include/CPU.hpp include/gameLoop.hpp include/mappers.hpp include/APU.hpp include/debugger.hpp
...
WINFLAGS     = -lmingw32 -lSDL2main -lSDL2 -static-libgcc -static-libstdc++ -Wl,-Bstatic -lstdc++ -lpthread -Wl,-Bdynamic
LINK_FLAGS   = -lSDL2 -lstdc++ -lpthread
